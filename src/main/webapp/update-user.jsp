...
<div class="w-full h-full flex flex-col gap-4 justify-center items-center">
    <h1 class="text-xl">Update User</h1>
    <form class="space-y-6 w-[30%]" id='form' action="/update-user" method="POST">
        ...
        <div>
            ...
            <div class="mt-2">
                <input id="username" name="username" type="text" autocomplete="username" value="${sessionScope.user.getUsername()}" required class="block w-full rounded-md border-0 py-1.5 px-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-2">
                <input id="email" name="email" type="email" autocomplete="current-email" value="${sessionScope.user.getEmail()}" required class="block w-full rounded-md border-0 py-1.5 px-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
        </div>
